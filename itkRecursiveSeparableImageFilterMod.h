/*=========================================================================
  ...
  Module:    $RCSfile: itkRecursiveSeparableImageFilterMod.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkRecursiveSeparableImageFilterMod_h
#define __itkRecursiveSeparableImageFilterMod_h
...
/** \class RecursiveSeparableImageFilterMod
 * \brief Base class for recursive convolution with a kernel.
 *
 * RecursiveSeparableImageFilterMod is the base class for recursive 
...
class ITK_EXPORT RecursiveSeparableImageFilterMod :
    public ImageToImageFilter<TInputImage,TOutputImage> 
{
public:
  /** Standard class typedefs. */
  typedef RecursiveSeparableImageFilterMod  Self;
  typedef ImageToImageFilter<TInputImage,TOutputImage>   Superclass;
  typedef SmartPointer<Self>   Pointer;
  typedef SmartPointer<const Self>  ConstPointer;

  /** Type macro that defines a name for this class. */
  itkTypeMacro( RecursiveSeparableImageFilterMod, ImageToImageFilter );
...
protected:
  RecursiveSeparableImageFilterMod();
  virtual ~RecursiveSeparableImageFilterMod() {};
  void PrintSelf(std::ostream& os, Indent indent) const;

  /** GenerateData (apply) the filter. */   
  void GenerateData(void);

  /** RecursiveSeparableImageFilterMod needs all of the input to produce an
   * output. Therefore, RecursiveSeparableImageFilterMod needs to provide
...
private:  
  RecursiveSeparableImageFilterMod(const Self&); //purposely not implemented
...
#include "itkRecursiveSeparableImageFilterMod.txx"
#endif
