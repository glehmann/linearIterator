/*=========================================================================
  ...
  Module:    $RCSfile: itkSmoothingRecursiveGaussianImageFilterMod.txx,v $
  Language:  C++
...
=========================================================================*/
#ifndef _itkSmoothingRecursiveGaussianImageFilterMod_txx
#define _itkSmoothingRecursiveGaussianImageFilterMod_txx
...
SmoothingRecursiveGaussianImageFilterMod<TInputImage,TOutputImage>
...
::GenerateInputRequestedRegion() throw(InvalidRequestedRegionError)
{
  ...
  typename SmoothingRecursiveGaussianImageFilterMod<TInputImage,TOutputImage>::InputImagePointer image = const_cast<InputImageType *>( this->GetInput() );
  if( image )
    {
...
::GenerateData(void)
{
  ...
  itkDebugMacro(<< "SmoothingRecursiveGaussianImageFilterMod generating data ");
